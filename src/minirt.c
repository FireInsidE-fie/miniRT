...
{
	create_sphere(make_point3(1.0, -1.0, 3.0), 1, (t_material){
		make_color(1.0, 0.0, 0.0),
		0.0f,
	});
	create_sphere(make_point3(0.0, 0.0, 5.0), 1, (t_material){
		make_color(0.0, 1.0, 0.0),
		1.0f,
	});
	create_sphere(make_point3(-1.0, 1.0, 7.0), 1, (t_material){
